...
<form action="index.php" method="GET">
			...
			<button type="submit" class="btn btn-primary btn-custom"><span class="glyphicon glyphicon-plus"></span> Créer un relevé </button>
		</form>
	...
	<thead>
		...
		<?php foreach($this->releve as $tab){?>
			<tr>
				...
				<form action="index.php" method="GET">
					<input type="hidden" name="controller" value="releves"/>
					<button type="submit" name="action" value="afficher" class="btn btn-primary btn-xs"><span class="glyphicon glyphicon-search datatables_action"></span></button>
					<button type="submit" name="action" value="editer" class="btn btn-primary btn-xs"><span class="glyphicon glyphicon-pencil datatables_action"></span></button>
					<button type="submit" name="action" value="supprimer" class="btn btn-primary btn-xs"><span class="glyphicon glyphicon-trash datatables_action"></span></button>
